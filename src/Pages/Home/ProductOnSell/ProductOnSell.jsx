      ...
      <div className="h-auto lg:h-[360px] bg-[#063A88] pr-2 pb-6 bg-opacity-90 w-full rounded-lg relative">
        ...
        <div className="flex flex-col lg:flex-row  items-center  h-full py-2">
          ...
          <div className="pl-5 w-full lg:w-1/4">
            ...
            <p className="text-xs  lg:text-xl text-white  mb-14">
              Shop Now!
            </p>
            <Link to='/shop' className="flex font-semibold hover:text-green-500 items-center  text-white text-sm lg:text-base ">
              View all
              <RiArrowRightSLine />
            </Link>
          </div>
