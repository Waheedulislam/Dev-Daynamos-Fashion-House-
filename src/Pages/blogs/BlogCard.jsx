      ...
      {blogs && blogs.length > 0 ? (
        blogs.slice(0, 4).map((blog) => (
          <Link to={`/blog/list/${blog._id}`} key={blog._id}>
            <div className="bg-white max-w-[392px] max-h-[400px] w-full shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-all transform duration-300 hover:scale-105 mx-auto">
              {/* Blog Image */}
              <img
                src={blog.imgSrc}
                alt={blog.title}
                className="max-h-[204px] w-full object-cover"
              />
                    ...
                    <span className="flex items-center gap-1">
                      <span>
                        ...
                        >
                          ...
                          />
                          <path
                            d="M12.5 2.29175H7.5C7.15833 2.29175 6.875 2.00841 6.875 1.66675C6.875 1.32508 7.15833 1.04175 7.5 1.04175H12.5C12.8417 1.04175 13.125 1.32508 13.125 1.66675C13.125 2.00841 12.8417 2.29175 12.5 2.29175Z"
                            fill="#717171"
                          />
                        </svg>
                      </span>
                ...
                {blog._id === "2" && (
                  <div>
                    <div className="flex items-center justify-between mt-2">
                      <a href="#" className="text-[#F45E0C] hover:underline">
                        Read More
                      </a>
                      <span>
                        <svg
